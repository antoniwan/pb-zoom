...
jest.mock("next/link", () => ({
  __esModule: true,
  default: ({ href, children }: NextLinkProps) => <a href={href}>{children}</a>,
}))
...
describe("ProfileCard", () => {
  ...
  it("renders profile information correctly", () => {
    render(<ProfileCard profile={mockProfile} onDelete={() => {}} onToggleVisibility={() => {}} />)
  ...
  it("renders placeholder image when primaryPicture is not provided", () => {
    render(<ProfileCard profile={mockProfileWithoutPicture} onDelete={() => {}} onToggleVisibility={() => {}} />)
  ...
  it("calls onDelete when delete button is clicked", () => {
    ...
    render(<ProfileCard profile={mockProfile} onDelete={handleDelete} onToggleVisibility={() => {}} />)
  ...
  it("calls onToggleVisibility when visibility button is clicked", () => {
    ...
    render(<ProfileCard profile={mockProfile} onDelete={() => {}} onToggleVisibility={handleToggleVisibility} />)
  ...
  it("displays correct visibility badge for private profile", () => {
    render(
      <ProfileCard profile={{ ...mockProfile, isPublic: false }} onDelete={() => {}} onToggleVisibility={() => {}} />,
    )
  ...
  it("validates required profile properties", () => {
    ...
    expect(() => {
      render(<ProfileCard profile={invalidProfile as Profile} onDelete={() => {}} onToggleVisibility={() => {}} />)
    }).not.toThrow()
  })
})
